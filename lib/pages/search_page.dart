...
class SearchPage extends StatelessWidget {
            ...
            () => controller.isLoading.value ? const Center(child: CircularProgressIndicator()) : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return InkWell(
                        ...
                        child: Stack(
                          children: [
                            ...
                            Positioned(
                              ...
                              right: 16.w,
                              child: Container(
                                padding: const EdgeInsets.only(left: 6, right: 6, top: 2, bottom: 2).r,
                  ...
                  onTap: () async => {
                    await controller.play(item['bvid']!)
                  }
                );
              },
            ),
  ...
  void _showPopupDialog(BuildContext context, Map<String, dynamic> itemInfo) {
    final titleController = TextEditingController();
    final authorController = TextEditingController();

    titleController.text = itemInfo['title'];
